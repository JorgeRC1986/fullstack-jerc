...
| Explore | This option allows you to search all the sites created using _**Ghost**_ so you can get inspired by all the users on the platform. |
| Posts | Shows a list of all the post created on your site. In this option you can create, edit, publish or delete posts.<br />You can filter your post by their status: _Drafts_, _Scheduled_, and _Published_. |
...
| Profile | This menu lets you manage your profile, see new releases, review help guides, and log out the Admin page. |
