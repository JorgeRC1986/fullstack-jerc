...
When you [publish](#publishing-a-post) a post, your site shows them on yopur home page in reverse chronological order by default, e.g. the newest post published on your site will always appear at the top of the homepage. Furthermore, the post normally appear on your homepage, tag collection pages, author collection pages, and your site's RSS feeds.
...
> To edit a published post, just click it in the list to open the Post editor. When finish, click _**Update**_ at the top of the editor.
